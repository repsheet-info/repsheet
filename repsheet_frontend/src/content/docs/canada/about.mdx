...
- We've avoided passing the MP's names, and the names of their parties, to the AI summarization, so that the summaries are not influenced by the historical news coverage of MPs.
