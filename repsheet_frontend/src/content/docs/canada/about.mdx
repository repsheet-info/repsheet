...
Repsheet attempts to create an unbiased summary of all current Canadian MPs. We use AI summarization with MP voting record histories to attempt to create unbiased accounts of how MPs vote.
